import { StyleSheet, Text, View,TouchableWithoutFeedback,Modal,TouchableOpacity } from 'react-native'
...
const SearchInput = ({inputs,setInputs,microphone,products,setNewProducts}) => {
                  ...
                  <View style={styles.modalView}>
                    ...
                    {errorText ? (
                      <>
                        ...
                        <Icon
                          style={{ position: "absolute", top: windowHeight/18, right:windowWidth/2.36  }}
                          size={30}
                          name="microphone"
                          color="white"
                        />
